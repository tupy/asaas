...
class PaymentsWebhook {
    constructor() {
         ...
         */
        this.PAYMENT_APPROVED_BY_RISK_ANALYSIS = 'PAYMENT_APPROVED_BY_RISK_ANALYSIS';
        /**
         * Pagamento em cartão reprovado pela análise manual de risco.
         */
        this.PAYMENT_REPROVED_BY_RISK_ANALYSIS = 'PAYMENT_REPROVED_BY_RISK_ANALYSIS';
        /**
         ...
         */
        this.PAYMENT_AWAITING_CHARGEBACK_REVERSAL = 'PAYMENT_AWAITING_CHARGEBACK_REVERSAL';
        /**
